...
fetch('/data/products.json')
    ...
    .then((data) => {
        // Filtrar productos por categoría 'Gorras'
        const gorras = data.filter(product => product.categoria === 'Gorras');
        const container = document.getElementById('gorras-container');
